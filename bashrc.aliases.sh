...
#}}}
#{{{ >>>   Draw a Border around Outcome    #>123
border(){
    read -p"> " COMM
    $COMM | awk '{
...
lcplay() {
mpv --term-status-msg="A: \${time-pos} / \${duration} (\${percent-pos}%)" $@ >/dev/null
}
